...
export default function AuthDialog({ isOpen, onClose, redirectTo = "/", defaultTab = "login" }: AuthDialogProps) {
  ...
  useEffect(() => {
    const updateHeight = () => {
      const activeRef = activeTab === "login" ? loginContentRef : signupContentRef
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="sm:max-w-md p-0 gap-0 max-h-[95vh] overflow-hidden [&>button]:hidden">
        ...
        <div className="flex-1 overflow-hidden">
          ...
          >
            <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full !border-none outline-none shadow-none">
              <TabsContent value="login" className="mt-0 px-6 " ref={loginContentRef}>
                <Form {...loginForm}>
              ...
              <TabsContent value="signup" className="mt-0 px-6 pt-2 border-none" ref={signupContentRef}>
                <Form {...signupForm}>
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              ...
                              {...field}
                              onChange={(e) => {
                                const currentValue = signupForm.getValues("contactNumber")
