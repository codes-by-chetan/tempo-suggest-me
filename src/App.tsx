  ...
  useEffect(() => {
    if (scrollRef.current) {
      ...
      if (scrollableElement) {
        ...
        // Fallback: try to scroll the ScrollArea container itself
        scrollRef.current.scrollTo({ top: 0, behavior: "smooth" })
      }
    }
  }, [location.pathname]) // Use location.pathname for more precise tracking
      ...
      >
        <main className="flex items-center justify-center pb-10 my-auto">
          <Routes>
            ...
            <Route path="/suggested-to-me/suggestion/:suggestionId" element={<SuggestionDetails />} />
